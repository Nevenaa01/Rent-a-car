...
public class RentACarObjekatService {
	...
	@GET
	@Path("/sort/{parametar}/{rastuciRedosled}/{vrstaVozila}/{tipGoriva}/{otvoreno}/{nazivObjekta}/{tip}/{lokacija}/{prosecnaOcena}")
	@Produces(MediaType.APPLICATION_JSON)
	public ArrayList<RentacarObjekat> sort(@PathParam("parametar") String parametar, @PathParam("rastuciRedosled") boolean rastuciRedosled, @PathParam("vrstaVozila") String vrstaVozila, @PathParam("tipGoriva") String tipGoriva, @PathParam("otvoreno") boolean otvoreno,
			@PathParam("nazivObjekta") String nazivObjekta, @PathParam("tip") String tip, @PathParam("lokacija") String lokacija, @PathParam("prosecnaOcena") Double prosecnaOcena){
		RentACarObjekatDAO rentACarObjekatDAO = (RentACarObjekatDAO) ctx.getAttribute("rentACarObjekatDAO");

		return rentACarObjekatDAO.sort(parametar, rastuciRedosled, vrstaVozila, tipGoriva, otvoreno, nazivObjekta, tip, lokacija, prosecnaOcena);
	}
