Vue.component("pocetna", {
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 d-flex justify-content-end">
					...
					<a class="linkLabela"><label id="pretragaId" class="btn btnSearch aktivnoDugme" for="option1">Pretraga</label><a>
				</div>
	...
	methods: {
		pretrazi : function(){
			...
			this.validnaProsecnaOcena = regex.test(this.pretraga.prosecnaOcena);
