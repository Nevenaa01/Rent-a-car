Vue.component("PrikazSvihVozila", {
	...
	template: ` 
 	<div class="pozadina">
		...
		<div class="container" v-if="this.ulogovan">
			...
			<div class="row">
				 ...
				 <button class="btn btnSearch" value="Kreiraj vozilo" v-on:click="kreirajVozilo()">Kreiraj vozilo</button>
		        </div>
		        <div class="col-sm-6 d-flex justify-content-center align-items-cente marginagornja"  v-if="this.ulogovan">
	...
	mounted() {
		...
		axios
			.get('rest/rentACarObjekat/svavozila/' + this.id)
			.then(response => {
